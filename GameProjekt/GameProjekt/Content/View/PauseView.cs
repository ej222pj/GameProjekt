...
namespace GameProjekt.Content.View
{
    class PauseView
    {
        internal void Draw(SpriteBatch spriteBatch, Button btnPlay, Button btnMainMenu, Button btnInstructions, ContentManager Content, GraphicsDeviceManager graphics)
        {
            spriteBatch.Begin(); 
